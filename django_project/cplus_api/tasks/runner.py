...
def run_dummy_task():
    ...
    analysis_extent = [878529.3786140494, 911063.0818645271, 7216308.751738624, 7279753.465204147]
    ...
    task_dict = {
        'scenario_name': analysis_scenario_name,
        'scenario_desc': analysis_scenario_description,
